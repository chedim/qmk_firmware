...
[_QWERTY] = LAYOUT( \
  ...
  [_LOWER] = LAYOUT( \
  //,-----------------------------------------------------------.                ,-----------------------------------------------------------.
       KC_GESC,  KC_EXLM,    KC_AT,  KC_HASH,   KC_DLR,  KC_PERC,                   KC_CIRC,  KC_AMPR,  KC_ASTR, KC_MINUS,    _____,   KC_DEL,\
  //|---------+---------+---------+---------+---------+---------|                |---------+---------+---------+---------+---------+---------|
        KC_TAB,  KC_HOME,  KC_PGDN,  KC_PGUP,   KC_END,    XXXXX,                   KC_LEFT,  KC_DOWN,    KC_UP, KC_RIGHT,  KC_QUOT,   KC_EQL,\
  //|---------+---------+---------+---------+---------+---------|                |---------+---------+---------+---------+---------+---------|
       KC_LBRC, KC_GRAVE,    XXXXX,    XXXXX,    RESET,    _____,                   KC_UNDS,  KC_PLUS,  KC_LBRC,  KC_RBRC,  KC_BSLS,  KC_RBRC
  //.-----------------------------------------------------------.                ,-----------------------------------------------------------.
  ),
  ...
  //|---------+---------+---------+---------+---------+---------|                |---------+---------+---------+---------+---------+---------|
       KC_CAPS,     KC_1,     KC_2,     KC_3,     KC_4,     KC_5,                      KC_6,     KC_7,     KC_8,     KC_9,     KC_0,    _____,\
  //|---------+---------+---------+---------+---------+---------|                |---------+---------+---------+---------+---------+---------|
       KC_LCBR,   KC_F11,   KC_F12,   KC_F13,   KC_F14,   KC_F15,                     _____,    _____,    _____,    _____,    _____,  KC_RCBR
  //,-----------------------------------------------------------.                ,-----------------------------------------------------------.
  ),
